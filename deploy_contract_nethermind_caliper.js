...
async function deploy() {
    ...
    console.log('\nUpdating networkconfig_nethermind_caliper.json...');
    const config = JSON.parse(fs.readFileSync('./networkconfig_nethermind_caliper.json', 'utf8'));
    config.ethereum.contracts.StateBloater.address = address;
    config.ethereum.contracts.StateBloater.abi = artifact.abi;
    fs.writeFileSync('./networkconfig_nethermind_caliper.json', JSON.stringify(config, null, 2));
