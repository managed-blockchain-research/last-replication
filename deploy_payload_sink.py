#!/usr/bin/env python3
"""Deploy PayloadSink contract — large-calldata JVM heap pressure test"""
...
print(f'✓ Connected to Besu (block {w3.eth.block_number})')

with open('PayloadSink.json', 'r') as f:
...
config['ethereum']['contracts']['PayloadSink'] = {'address': contract_address}
