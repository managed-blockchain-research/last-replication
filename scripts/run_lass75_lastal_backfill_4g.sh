#!/bin/bash
# lass75 + last_al backfill — 2 runs each (runs 6-7) to achieve N=5 valid per variant.
# Uses fully-debugged script (all fixes: clearSubscriptions, transactionPollingTimeout:12, chainId:1337).
# Stores results in original 4g experiment RESULTS_DIR.
set -e
...
RUN_ID="20260424_backfill2"

echo "======================================================================"
echo "LASS75 + LAST_AL BACKFILL — 2 runs each (runs 6-7) @ 4g heap"
...
echo ""
echo "=============================="
echo "LAST_AL BACKFILL: runs 6-7"
echo "=============================="
...
echo ""
echo "======================================================================"
echo "BACKFILL COMPLETE — lass75_6-7 and last_al_6-7"
