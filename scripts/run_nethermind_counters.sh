...
OUT_DIR="${ROOT}/results/nethermind/retry-${TS}-counters"
...
echo "==> Nethermind baseline (dotnet-counters)..."
...
echo "==> Nethermind e-spill (dotnet-counters)..."
...
echo "✅ Nethermind counters retry finished."
