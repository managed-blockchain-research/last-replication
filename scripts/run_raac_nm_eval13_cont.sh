#!/usr/bin/env bash
# eval13 CONTINUATION — skip static_nm_1 (already complete), resume from moderate_nm_1
set -euo pipefail
cd /home/yeochan.yoon/caliper-stress-test

# Reuse the same RUN_ID so results stay together
...
echo ""
echo "======================================================================"
echo "eval13 CONTINUATION (fixed FeeTooLowToCompete backoff) | RUN_ID: ${RUN_ID}"
echo "  Skipping: static_nm_1 (complete)"
echo "  Resuming: moderate_nm_1 onwards"
echo "======================================================================"
...
echo ""
echo "=============================="
echo "Resuming eval13: moderate_nm_1 → aggressive_nm_3"
echo "=============================="

# i=1: skip static (done), run moderate+aggressive
run_config "moderate"   "1" || echo "  WARNING: moderate_nm_1 failed, continuing"
sleep 15
run_config "aggressive" "1" || echo "  WARNING: aggressive_nm_1 failed, continuing"
sleep 15

# i=2,3: all three configs
for i in 2 3; do
...
echo ""
echo "======================================================================"
echo "eval13 CONTINUATION COMPLETE — results in ${RESULTS_DIR}"
echo "======================================================================"
