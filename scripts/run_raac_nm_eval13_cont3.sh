#!/usr/bin/env bash
# eval13 CONTINUATION 3 — TxPool.Size=40000 fix (max safe for MemoryHint=4GB), start from aggressive_nm_1
# static_nm_1 and moderate_nm_1 are done.
set -euo pipefail
...
echo ""
echo "======================================================================"
echo "eval13 CONTINUATION 3 (TxPool=40000 + conn-backoff) | RUN_ID: ${RUN_ID}"
echo "  Done: static_nm_1, moderate_nm_1"
echo "  Resuming: aggressive_nm_1 onwards"
echo "======================================================================"
...
echo ""
echo "=============================="
echo "Resuming eval13: aggressive_nm_1 → aggressive_nm_3"
echo "=============================="

# rep 1: aggressive (static_nm_1 and moderate_nm_1 are done)
run_config "aggressive" "1" || echo "  WARNING: aggressive_nm_1 failed, continuing"
sleep 15

# reps 2 and 3: all three configs
for i in 2 3; do
...
echo ""
echo "======================================================================"
echo "eval13 CONTINUATION 3 COMPLETE — results in ${RESULTS_DIR}"
echo "======================================================================"
