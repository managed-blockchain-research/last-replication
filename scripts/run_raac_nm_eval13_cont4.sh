#!/usr/bin/env bash
# eval13 CONTINUATION 4 — TxPool.Size=8192 (320MB, keeps baseline ~530MB)
# All 9 runs from scratch with consistent TxPool size.
# TxPool.Size history: 4096 (overflow), 65536 (NM crash), 40000 (baseline inflated to 2.2GB), 8192 (correct)
# With 8192: baseline~530MB, aggressive threshold hits min at RSS~730MB (~20s into attack)
set -euo pipefail
cd /home/yeochan.yoon/caliper-stress-test

RUN_ID="20260504_183404_raac_nm_eval13"
...
echo ""
echo "======================================================================"
echo "eval13 CONTINUATION 4 (TxPool=8192 all 9 runs) | RUN_ID: ${RUN_ID}"
echo "  TxPool=8192: 320MB reserved, baseline~530MB, configs distinguishable"
echo "  Runs: static×3 + moderate×3 + aggressive×3 (interleaved)"
echo "======================================================================"
...
echo ""
echo "=============================="
echo "Starting eval13: all 9 runs (TxPool=8192)"
echo "=============================="
...
echo ""
echo "======================================================================"
echo "eval13 CONTINUATION 4 COMPLETE — results in ${RESULTS_DIR}"
echo "======================================================================"
