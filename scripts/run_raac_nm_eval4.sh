...
RUN_ID="20260429_184600_raac_eval4"
...
echo "======================================================================"
echo "RAAC NM eval4 | RUN_ID: ${RUN_ID}"
echo "======================================================================"
...
ensure_ai_service() {
    # Check if serve.py is running; if not, restart it
    if ! pgrep -f "serve.py" > /dev/null 2>&1; then
        echo "  AI service (serve.py) not running — restarting..."
    ...
    while [ $c -lt 20 ]; do
        ...
        echo -n "  AI not ready yet..."; sleep 2; c=$((c+1))
    done
    echo "  AI service FAILED to come up"
    return 1
}
...
run_nm_single() {
    ...
    # Ensure AI service is up before each run
    ensure_ai_service || {
...
echo ""
echo "======================================================================"
echo "raac_nm eval4 COMPLETE — results in ${RESULTS_DIR}"
echo "======================================================================"
