...
# Start BASELINE Besu with VERY SMALL heap to induce heavy GC pressure quickly

set -e

BESU_BIN="/home/yeochan.yoon/besu-24.1.1/bin/besu"
DATA_DIR="/home/yeochan.yoon/caliper-stress-test/data_baseline_harsh"
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
GC_LOG_FILE="/home/yeochan.yoon/caliper-stress-test/baseline_harsh_gc_${TIMESTAMP}.log"

echo "======================================================================"
echo "Starting BASELINE Besu in Dev Mode (TINY HEAP for GC Stress Testing)"
echo "======================================================================"
...
echo "${BESU_PID}" > /tmp/besu_baseline_harsh.pid
...
echo ""
echo "======================================================================"
echo "Baseline Besu is ready for HARSH GC stress testing!"
echo "======================================================================"
...
echo "PID File: /tmp/besu_baseline_harsh.pid"
echo ""
